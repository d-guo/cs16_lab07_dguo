...
Node * pointerToMax(LinkedList *list) {
  ...
  return ptomax; // STUB!  Replace this line with correct code
}
...
Node * pointerToMin(LinkedList *list) {
  ...
  return ptomin; // STUB!  Replace this line with correct code
...
int largestValue(LinkedList *list) {
  ...
  Node* ptomax;
  ptomax = pointerToMax(list);

  return (*ptomax).data; // STUB!  Replace this line with correct code
...
int smallestValue(LinkedList *list) {
  ...
  Node* ptomin;
  ptomin = pointerToMin(list);

  return (*ptomin).data; // STUB!  Replace this line with correct code
